...
| Status group is empty (List View, no filter active) | Group still shown with header and count = 0 |
| Status group is empty (List View, filter active) | Group is **hidden entirely** |
